...
`,fn=by(),za=Vs(Gs.DIRECTIVES,[]);var Sd;const uy=Ks((Sd=fn.getQueryType())==null?void 0:Sd.getFields());var wd;const ly=Ks((wd=fn.getMutationType())==null?void 0:wd.getFields());var Fd;const cy=Ks((Fd=fn.getSubscriptionType())==null?void 0:Fd.getFields()),ou=kt.keyBy(Pf(),r=>r.name.toLocaleLowerCase()),dy=kt.mapValues(ou,r=>{const n=za.find(t=>(t==null?void 0:t.name)===r.name||(t==null?void 0:t.name)==="*");return n?n.args.some(t=>t==="*")?r.args:n.args.map(t=>r.args.find(o=>o.name===t)).filter(t=>!!t):[]}),fy=Ks(fn.getTypeMap()),hy=iy(fn);function Ks(r){return kt.mapKeys(r||{},(n,t)=>t.toLocaleLowerCase())}function py(){return kt.size(fn.getTypeMap())<=10}function gy(){return[Sa("Queries",fn.getQueryType()),Sa("Mutations",fn.getMutationType()),Sa("Subscriptions",fn.getSubscriptionType()),Ty(),Ey()].filter(r=>!!r)}function Sa(r,n){return Dy(r,my(n))}function my(r){return kt.sortBy((r==null?void 0:r.getFields())||{},n=>n.name)}function Dy(r,n){return n.length===0?null:{type:"menu",title:r,children:n.map(t=>({type:"page",title:t.name,section:r,deprecated:!!t.deprecationReason,href:wi.joinUrlPaths(Ws(),r.toLocaleLowerCase(),t.name)}))}}function Ey(){return py()?null:{type:"menu",title:"Types",children:kt.sortBy(kt.map(fn.getTypeMap()),n=>n.name).filter(n=>!n.name.startsWith("__")).map(n=>({type:"page",title:n.name,section:"Types",href:wi.joinUrlPaths(Ws(),"types",n.name)}))}}function By(){return!!fn.getQueryType()}function zy(r){return uy[r.toLocaleLowerCase()]}function My(){return!!fn.getMutationType()}function $y(r){return ly[r.toLocaleLowerCase()]}function Py(){return!!fn.getSubscriptionType()}function Uy(r){return cy[r.toLocaleLowerCase()]}function Gy(r){return fy[r.toLocaleLowerCase()]}function vy(r){return ou[r.toLocaleLowerCase()]}function Vy(r){return vy(r.name)!==void 0}function Wy(){return kt.size(ou)>0}function jy(r){return dy[r.name.toLocaleLowerCase()]||[]}function qy(r){if(r)return hy.getFor(r)}function Zy(r){return kt.flatMap(r.getFields(),n=>({field:n,possibleDescriptions:$f(n,r)}))}function $f(r,n){return r?r.description?[{description:r.description,from:n}]:je(n)?n.getInterfaces().flatMap(t=>$f(t.getFields()[r.name],t)):[]:[]}function Pf(){return za.some(r=>(r==null?void 0:r.name)==="*")?fn.getDirectives().filter(r=>!["include","skip","deprecated","specifiedBy"].includes(r.name)):za.filter(r=>!!(r!=null&&r.name)).map(({name:r})=>r?fn.getDirective(r):void 0).filter(r=>!!r)}function by(){return yd.trim().length===0?XI(JSON.parse(JSON.stringify({__schema:{types:[]}}))):ry(yd)}function Ty(){const r=Pf();return r.length===0?null:{type:"menu",title:"Directives",children:r.map(n=>({type:"page",title:n.name,href:wi.joinUrlPaths(Ws(),"directives",n.name),section:"Directives"}))}}const Hy=Vs(Gs.APP_TITLE,"GraphQL Documentation"),Uf=Iy().concat(gy());Ay(Uf);const _y=Object.freeze(Uf),Jy=yy();function Iy(){return Vs(Gs.PAGES,wy()).filter(n=>!!n).map(n=>Vf([],n))}function yy(){const r=Sy();if(r)return r.href;throw new Error("No custom pages or query available to use as the root application URL. You need to provide at least one custom page or your schema should contain at least one query/mutation/subscription.")}function Ay(r){function n(o,s){for(const a of o){if(a.type==="page"){s(a);continue}a.type==="menu"&&n(a.children,s)}}let t;n(r,o=>{t&&(t.next={title:o.title,section:o.section,href:o.href},o.previous={title:t.title,section:t.section,href:t.href}),t=o})}function Sy(){return Gf(()=>!0)}function Ky(r){return Gf(n=>n.href.toLocaleLowerCase()===r.toLocaleLowerCase())}function Gf(r){function n(t){for(const o of t){if(o.type==="page"&&r(o))return o;if(o.type==="menu"){const s=n(o.children);if(s)return s}}return null}return n(_y)}function Vf(r,n){if(typeof n.content=="string")return{type:"page",title:n.title,content:n.content,href:wi.joinUrlPaths(Ws(),...r,Ad(n.title))};const t=r.concat([Ad(n.title)]);return{type:"menu",title:n.title,children:n.content.map(o=>({...Vf(t,o),section:n.title}))}}function Ad(r){return wi.generatePathSegment(r,new xd)}function wy(){return[{title:"Introduction",content:[{title:"Welcome",content:`
        # Welcome 🎉
        ...
        `.split(`
`).map(r=>r.trim()).join(`
`)}]}]}export{xT as A,py as B,Gy as C,qy as D,Yt as E,et as F,Ge as G,Pn as H,je as I,En as J,T as K,Zy as L,gr as M,zr as N,Ly as O,Ps as P,Cd as Q,Di as R,xy as S,xd as T,Ee as U,Yn as V,Hy as W,kt as _,My as a,By as b,zy as c,Py as d,Uy as e,Ky as f,$y as g,Jy as h,kd as i,Oy as j,Wy as k,vy as l,jy as m,Ws as n,Vy as o,_y as p,ct as q,uf as r,fn as s,vn as t,wi as u,Ae as v,Ry as w,Vs as x,Gs as y,di as z};
